...
def astar(start_state, goal_state, grid):
    open_set = []
    closed_set = set()
    ...
    while open_set:
        ...
        for neighbor_state in get_neighbors(current_state, grid):
            ...
            if neighbor_state not in [n[1] for n in open_set] or tentative_g_score < g_score.get(neighbor_state, float('inf')):
                came_from[neighbor_state] = current_state
                g_score[neighbor_state] = tentative_g_score
                f_score = tentative_g_score + heuristic(neighbor_state, goal_state)
...
path = astar(start_state, goal_state, grid)
